...
<body oncontextmenu="return false" onkeydown="return false;" onmousedown="return false;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var distance = 10000;
            var flag = 1;
            var treasurePin = [treasureLocation[0],treasureLocation[1]]
            ...
            map.on('click', function (e) {
                ...
                if (remainingTries >= 0 && distance > 50) {
                    ...
                    if (remainingTries == 5) {
                        var popupContent = `<p>Remaining Tries: ${remainingTries}</p>
                              <p>You are  ${distance} kms away from the treasure</p>
                ...
                if (flag == 0) {
                    var correctPopupContent = `<p>Game Over!</p>
                                       ...
                                       <p>Longitude: ${treasurePin[0]}</p>
                                       <p>Latitude: ${treasurePin[1]}</p>`;
                    new mapboxgl.Popup()
                        .setLngLat(treasurePin)
                    ...
                    alert(
                        "Sorry, you've used up all your guesses. The treasure was located in " +
                        treasureLocation[2] + " " + treasureLocation[3] + "."
